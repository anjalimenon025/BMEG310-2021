...
k_means2 <- kmeans(m.pca$x, centers = length(unique(pca_clinical$lifespan_in_days))) #Kmeans of data points 
fviz_cluster(k_means2, data=m.pca$x, choose.vars=c("PC1", "PC2"), geom="point") #Clustering 
