...
#Organizing data and retreiving gene information
```{r}
...
ID_patient <- intersect_all(ID_patient, rownames(barcode))
...
ggplot(res.plot, aes(x=log2FoldChange, y=-log(pvalue)))+ geom_point()
