...
---
The following code is adapted from the differential equations code. In this code, the data is divided into 4 clusters and then pca is performed and k-means clustering afterwards. This code is for the RNA data. 
```{r}
library(pheatmap)
library(reshape)
library(plyr)
